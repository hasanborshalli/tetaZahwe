...
@section('description', 'Get in touch with Teta Zahwe Catering.')
...
<section class="contact-section">
    ...
    <div data-reveal>
        ...
        <p class="body-text">
            ...
            your office, or just want to ask a question — we're here.
                ...
                <div class="form-row">
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" id="subject" name="subject" class="form-input"
                            placeholder="What is it about?" value="{{ old('subject') }}" />
                    </div>
                </div>
